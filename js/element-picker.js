function Picker (array, name, container, cb = null) {
    ...
    this.toggle = function(event){
        ...
        if(!event.toElement.classList.contains('selected')){
            var elSelected = event.toElement.parentNode.querySelector('.picker-item.selected');
    ...
    this.selected = function(){
        let container = document.getElementById(this.id);
        let selected = container.querySelector('ul li.picker-item.selected').getAttribute('data-picker');
        return selected;
    }
